...
export const AmenitiesIcons = [
  ...
  { name: 'Parking Lot', icon: { icon: 'mdi:car', color: '#607D8B' } },
  { name: 'BBQ Area', icon: { icon: 'mdi:grill', color: '#E91E63' } },
  { name: 'Shelter/Pavilion', icon: { icon: 'mdi:home-roof', color: '#3F51B5' } },
  { name: 'Lake or Pond', icon: { icon: 'mdi:water', color: '#2196F3' } },
  { name: 'Climbing Wall', icon: { icon: 'mdi:wall', color: '#9E9E9E' } },
  { name: 'Zip Line', icon: { icon: 'mdi:cable-data', color: '#00BCD4' } },
